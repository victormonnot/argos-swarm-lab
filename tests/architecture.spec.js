...
test('keyboard selection, mobile layout and all workshop links remain usable', async ({ page }) => {
  ...
  for (const [route, id] of [['/consensus/', '#step-count'], ['/movement/', '#movement-step-count'], ['/mission/', '#mission-step-count'], ['/architecture/', '#arch-step-count'], ['/pathfinding/', '#path-step-count'], ['/localization/', '#loc-step-count'], ['/fusion/', '#fusion-round'], ['/orca/', '#orca-step-count'], ['/cbba/', '#cbba-round'], ['/behavior/', '#behavior-step-count'], ['/cooperative/', '#coop-step-count'], ['/slam/', '#slam-step-count'], ['/pose-graph/', '#graph-iteration'], ['/ros2/', '#ros-round'], ['/qos/', '#qos-time-label'], ['/restart/', '#restart-time'], ['/middleware/', '#middleware-time'], ['/sitl/', '#sitl-time'], ['/gazebo/', '#gazebo-time'], ['/failsafe/', '#failsafe-time'], ['/fleet/', '#fleet-time'], ['/recovery/', '#recovery-time'], ['/shared-world/', '#shared-world-time']]) {
    await page.getByRole('navigation', { name: 'Workshops', exact: true }).getByRole('combobox', { name: 'Choose a workshop', exact: true }).selectOption(route);
