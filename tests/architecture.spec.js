...
test('keyboard selection, mobile layout and all workshop links remain usable', async ({ page }) => {
  ...
  for (const [name, id] of [['01 / Average consensus', '#step-count'], ['02 / Potential fields', '#movement-step-count'], ['03 / Task allocation', '#mission-step-count'], ['04 / Decision architectures', '#arch-step-count'], ['05 / A* path planning', '#path-step-count'], ['06 / Kalman position filtering', '#loc-step-count'], ['07 / Shared estimates', '#fusion-round'], ['08 / ORCA collision avoidance', '#orca-step-count']]) {
